...
import com.mzakialkhairi.githubsearch.view.activity.SplashActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TYPE_REPEATING = "Github App is waiting you."
    ...
    private fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val notifDetailIntent = Intent(context, SplashActivity::class.java)
